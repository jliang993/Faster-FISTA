...
[alpha_est(p,para.beta, x, para.A, J), r_a, r_ar]
...
[alpha_est(p,para.beta, x, para.A, J), r_a; r_ar, r_ab]
...
% pasrb = semilogy(ek_ab, '--', 'Color',[0.99,0.01,0.99], 'LineWidth',linewidth);
...
lg = legend([p1, p2, p3,p4, pas1,pasr, pr], 'FISTA-BT',...
    ...
    'Ada-FISTA, $p=1, q=1$', 'Ada-FISTA+Restart, $p=1, q=1$',...
    'Restarting FISTA');
...
% pasb = semilogy(phik_ab-phisol, '--', 'Color',[0.99,0.01,0.99], 'LineWidth',linewidth);
